...
<head>
    ...
    <title>Se connecter | Volontaires Croix-Rouge</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script src="https://unpkg.com/feather-icons"></script>
    <script src="https://cdn.jsdelivr.net/npm/feather-icons/dist/feather.min.js"></script>
    <style>
        .login-bg {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('http://static.photos/people/1200x630/50');
    ...
    <nav class="bg-white shadow-sm">
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div>
                    <a href="/register" class="text-gray-600 hover:text-red-600 px-4 py-2">S'inscrire</a>
                    <a href="/dashboard" class="text-gray-600 hover:text-red-600 px-4 py-2">Tableau de bord</a>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 login-bg">
        <div class="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 mt-2">Accédez à votre espace volontaire</p>
            </div>
            
            <form class="space-y-6">
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700">Email ou téléphone</label>
                    <input type="text" id="email" name="email" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500">
                </div>
                ...
                <div>
                    ...
                    <div class="flex justify-end mt-1">
                        <a href="/forgot-password" class="text-sm text-red-600 hover:text-red-500">Mot de passe oublié?</a>
                    </div>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Pas encore membre ? 
                    <a href="/register" class="font-medium text-red-600 hover:text-red-500">Créez un compte</a>
                </p>
            </div>
        </div>
    </div>
